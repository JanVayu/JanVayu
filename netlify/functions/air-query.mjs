...
${instruction9}
10. LENGTH & FORMAT — keep it SHORT: a hard limit of ~120 words. Lead with the direct answer in 1-2 sentences, then at most 3-4 brief supporting points. No walls of text. Write PLAIN TEXT: do NOT use markdown — no **bold**, no # / ## / ### headings, no tables, no | pipes. For a short list, use a plain dash (-) at the start of a line. Clean and readable, like a helpful text message.
