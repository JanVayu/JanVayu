...
The first of the five situations on the front page. The label was written to move the framing away from a middle-class urban one, where being outdoors is a choice, toward the errands people actually run on a bad-air morning. "Vegetables" was a narrower reading of that than intended and sounded odd in English; groceries is the errand.

One string, used positionally with no translation keyed to it.
