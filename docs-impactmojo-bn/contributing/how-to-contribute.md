...
| ধরন | কীভাবে |
|------|-----|
| **বাগ রিপোর্ট** | একটি [GitHub Issue](https://github.com/JanVayu/ImpactMojo/issues) খুলুন |
| **ফিচার অনুরোধ** | একটি [GitHub Discussion](https://github.com/JanVayu/ImpactMojo/discussions) শুরু করুন |
