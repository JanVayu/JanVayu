...
- 🖼️ **"The air, in pictures"** photo gallery — 29 openly-licensed documentary photographs (Wikimedia Commons), reachable from *Learn → Photo Gallery*.
...
| 40 | **Photo Gallery** | "The air, in pictures" — 29 openly-licensed (CC / public-domain) documentary photographs from Wikimedia Commons in a masonry grid + full-screen lightbox with per-image credit and source |
