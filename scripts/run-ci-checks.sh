...
echo "--- [guard-site-figures] python3 scripts/check-design-system.py"; python3 scripts/check-design-system.py >/dev/null 2>&1 || { echo "   FAIL: python3 scripts/check-design-system.py"; python3 scripts/check-design-system.py 2>&1 | tail -6; }
echo "--- [guard-site-figures] python3 scripts/check-asset-freshness.py"; python3 scripts/check-asset-freshness.py >/dev/null 2>&1 || { echo "   FAIL: python3 scripts/check-asset-freshness.py"; python3 scripts/check-asset-freshness.py 2>&1 | tail -6; }
echo "--- [guard-site-figures] python3 scripts/check-theme-surfaces.py"; python3 scripts/check-theme-surfaces.py >/dev/null 2>&1 || { echo "   FAIL: python3 scripts/check-theme-surfaces.py"; python3 scripts/check-theme-surfaces.py 2>&1 | tail -6; }
