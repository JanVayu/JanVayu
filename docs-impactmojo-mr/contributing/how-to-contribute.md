...
| प्रकार | कसे |
|------|-----|
| **बग अहवाल** | [GitHub Issue](https://github.com/JanVayu/ImpactMojo/issues) उघडा |
| **वैशिष्ट्य विनंत्या** | [GitHub Discussion](https://github.com/JanVayu/ImpactMojo/discussions) सुरू करा |
